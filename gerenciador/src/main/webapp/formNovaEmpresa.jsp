...
<html lang="pt-br">
 ...
 <body>
	...
	<!-- pegando informação do input e do parametro "nome" da Servlet-->
		...
		<form action="${linkServletNovaEmpresa}" method="post">
			...
			<h5 class="fw-bold fs-3 text-center">Form</h5>
	  		<div class="mb-3">
	    		...
	    		<input type="text" name="nome" class="form-control" id="nameCompany" placeholder="Company">
	  		</div>
	  		<div class="mb-3">
	    		<label for="exampleInputEmail1" class="form-label">Email address</label>
	    		<input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="name@email.com">
	  		...
	  		<div class="mb-3">
	    		...
	    		<input type="date" name="data" class="form-control" id="exampleDataAbertura" >
	  		</div>	  		
